...
// HTTP behaviour is covered in ali1688_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "ali1688://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("ali1688", "about")
	if err != nil || got.String() != "ali1688://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want ali1688://page/about", got.String(), err)
	}
}

---
title: "ali1688"
description: "Browse 1688.com wholesale products"
heroTitle: "ali1688, from the command line"
heroLead: "Browse 1688.com wholesale products One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
ali1688 links <path>           # the pages it links to, each addressable
ali1688 serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading ali1688 by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address ali1688 as
  `ali1688://` URIs and follow links across sites. See
